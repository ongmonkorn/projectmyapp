...
if (isset($_SESSION['user_id'])) {
    ...
    //$formattedbirthday = date("d/m/" . (date("Y") + 543) . " ", strtotime($row["user_birthday"]));
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row mt-2">
                <div class="content-header-left col-md-4 col-12">
                    <h3 class="content-header-title">แก้ไขข้อมูลส่วนตัว</h3>
                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="d-flex justify-content-center mt-2 p-4">
                                    <div class="rounded bg-light pt-2 px-2 pb-2 ">
                                        <img class="profile w-100" id="previewImage" src="../images/upload/<?php echo $row['user_file']; ?>" alt="profile">
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <form action="upload.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-2 text-center">
                                            ...
                                            <input class="btn btn-primary" style="margin: 0px 0px 7px;" type="submit" name="change_img" value="บันทึกรูปภาพ" id="editimg">
                                        </div>
                                        <div class="d-none">
                                ...
                                <form action="profile_edit_db.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-12 my-1">
                                            <div class="form-floating ">
                                                <select class="select form-select border-primary" name="pname">
                                                    ...
                                                    $user_pname_from_db = $row['user_pname'];
                                        ...
                                        <div class="col-md-4 col-sm-12 my-1">
                                            <div class="form-floating ">
                                                <input type="text" class="form-control border-primary" id="floatingInput" name="fname" placeholder="ชื่อ" value="<?php echo $row["user_fname"]; ?>" required="">
                                                <label for="floatingInput">ชื่อ</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 my-1">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-primary" id="floatingInput" name="lname" placeholder="นามสกุล" value="<?php echo $row["user_lname"]; ?>" required="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 my-1">
                                            <div class="form-floating">
                                                <input type="date" class="form-control border-primary" id="datepicker" name="birthday" placeholder="วันเกิด" value="<?php echo $row['user_birthday']; ?>" required="">
                                        ...
                                        <div class="col-md-6 col-sm-12 my-1">
                                            <div class="form-floating">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sex" id="femaleGender" value="ชาย" <?php echo ($row['user_sex'] == 'ชาย') ? 'checked' : ''; ?> />
                                                    <label class="form-check-label" for="femaleGender">ชาย</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sex" id="maleGender" value="หญิง" <?php echo ($row['user_sex'] == 'หญิง') ? 'checked' : ''; ?> />
                                                    <label class="form-check-label" for="maleGender">หญิง</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sex" id="otherGender" value="ไม่ระบุ" <?php echo ($row['user_sex'] == 'ไม่ระบุ') ? 'checked' : ''; ?> />
                                        ...
                                        <div class="col-md-6 col-sm-12 my-1">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-primary" id="floatingInput" name="email" placeholder="อีเมล" value="<?php echo $row["user_email"]; ?>" required="">
                                                <label for="floatingInput">อีเมล</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 my-1">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-primary" id="floatingInput" name="tel" placeholder="เบอร์โทร" value="<?php echo $row["user_tel"]; ?>" required="">
                                                <label for="floatingInput">เบอร์โทร</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 my-1">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-primary" row="3" id="floatingInput" name="contact" placeholder="ที่อยู่" value="<?php echo $row["user_contact"]; ?>" required="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 my-4">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a class="btn btn-secondary ms-2" href="profile.php">กลับ</a>
                                                </div>
                                            </div>
                                        </div>
                                </form>
    ...
    <script>
        ...
        function previewFile() {
            ...
            if (file) {
                ...
                preview.src = "../images/upload/<?php echo $row['user_file']; ?>";
            }
        }
