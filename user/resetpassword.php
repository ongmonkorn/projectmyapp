                            ...
                            <div class="card-block">
                                <div class="card-body">
                                    <fieldset class="form-group">
                                        <label class="label" for="password">รหัสผ่านใหม่ :</label>
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="password" id="password" placeholder="รหัสผ่านใหม่" required="">
                                    ...
                                    <fieldset class="form-group">
                                        <label class="label" for="password">ยืนยันรหัสผ่านใหม่ :</label>
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="password2" id="password2" placeholder="ยืนยันรหัสผ่านใหม่" required="">
                                    ...
                                    <div class="text-center text-lg-start pt-2">
                                        <button type="submit" name="login_user" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">บันทึก</button>
