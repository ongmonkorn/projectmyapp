                            ...
                            <div class="card-block">
                                <div class="card-body">
                                    ...
                                    <div class="text-center text-lg-start pt-2">
                                        <button type="submit" name="login_user" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">เข้าสู่ระบบ</button>
...
<script>
    ...
    if (isset($_SESSION['emailreset'])) { ?>
        ...
        Swal.fire({
            title: 'สำเร็จ',
            text: 'ส่งวิธีรีเซ็ตรหัสผ่านไปในอีเมลแล้ว',
            icon: 'success',
            confirmButtonText: 'OK'
        });
    ...
    if (isset($_SESSION['resetpasssuccess'])) { ?>
