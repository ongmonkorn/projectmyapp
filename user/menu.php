            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse show" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> <span class="avatar avatar-online"><img src="../images/upload/<?php echo $row['user_file']; ?>" alt="avatar"><i></i></span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="../images/upload/<?php echo $row['user_file']; ?>" alt="avatar"><span class="user-name text-bold-700 ml-1"><?php echo $row['user_fname']; ?></span></span></a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="../theme-assets/images/backgrounds/02.jpg">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="bru logo" src="../images/logo.png">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <!-- <li class="nav-item">
                    <a href="#">
                        <i class="ft-menu"></i>
                        <span class="menu-title" data-i18n="">เมนูย่อย</span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="#">
                                <span class="menu-title" data-i18n="">รายการ 1</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#">
                                <span class="menu-title" data-i18n="">รายการ 2</span>
                            </a>
                        </li>
                    </ul>
                </li> -->
                <li class="nav-item"><a href="list_training.php"><i class="ft-layers"></i><span class="menu-title" data-i18n="">โครงการอบรม</span></a>
                </li>
                <li class="nav-item"><a href="status.php?user_id=<?php echo $_SESSION['user_id']; ?>"><i class="la la-hourglass"></i><span class="menu-title" data-i18n="">สถานะลงทะเบียน</span></a>
                </li>
                <li class="nav-item"><a href="training_result.php"><i class="la la-check-square"></i><span class="menu-title" data-i18n="">ผลการอบรม</span></a>
                </li>
