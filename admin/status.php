...
JOIN user ON orders.user_id = user.user_id WHERE order_status = 0";
$result = $conn->query($sql);

// $sql3 = "SELECT * FROM training";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <p><?php echo $row2['user_pname'] . " " . $row2['user_fname'] . " " . $row2['user_lname'] ?></p>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-warning text-white" href="approve.php?order_id=<?php echo $row2['order_id']; ?>">
                                                        <i class="la la-edit"></i>
                                                    </a>
                                                </td>
                                            </tr>
