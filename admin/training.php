...
<body>
                            ...
                            <ul>
                                ...
                                <li class="list-group">
                                    <div class="d-flex">
                                        ...
                                        <?php echo $training["training_lecturer"]; ?>
                                        </h4>
                                    </div>
                                </li>
                            </ul>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        if ($resultfile->num_rows > 0) {
                                            ...
                                            while ($rowfile = $resultfile->fetch_assoc()) {
                                                ...
                                                echo "<td><a class='btn btn-primary' href='download.php?id=" . $rowfile["id"] . "'>ดาวน์โหลด</a></td>"; // ลิงก์สำหรับการดาวน์โหลดไฟล์
                                                echo "<td><button type='button' class='btn btn-danger' onclick='confirmDelete(" . $rowfile["id"] . ")'>ลบ</button></td>"; // เพิ่มปุ่มลบ
                                                echo "</tr>";
                                            }
                                            echo "</table>";
                                        } else {
    ...
    <script>
        ...
        if (isset($_SESSION['regsuccess'])) { ?>
            ...
            Swal.fire({
                title: "สำเร็จ!",
                text: "สมัครฝึกอบรมสำเร็จ ตรวจสอบชื่อของคุณได้ที่ตารางข้างล่าง",
                icon: "success",
