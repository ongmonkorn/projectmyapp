...
$sql2 = "SELECT COUNT(*) AS total_rowsreg FROM orders WHERE order_status = '0'";
$resulrowreg = mysqli_query($conn, $sql2);

$rowreg = $resulrowreg->fetch_assoc();
$totalRowsreg = $rowreg['total_rowsreg'];

$sql3 = "SELECT COUNT(*) AS total_rowsreg2 FROM orders WHERE order_status = 1";
            ...
            <div class="content-body">
                <div class="row match-height">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="card pull-up ecom-card-1 bg-white">
                            <div class="card-content ecom-card2 height-180">
                                <h3 class="text-muted primary position-absolute p-1">รออนุมัติ</h3>
                                <div>
                        ...
                        <div class="card" style="zoom: 1;">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <p><span class="text-bold-600">รายงาน</span> โครงการอบรม </p>
                                        ...
                                        <table id="table" class="table table-hover" style="width:100%">
                                            <thead>
                                                <tr class="table-primary">
                                                    ...
                                                    <th scope="col">ผู้เข้าอบรม</th>
                                                    <th scope="col" class="text-center">ผู้ผ่านการอบรม</th>
                                            ...
                                            <tbody>
                                                ...
                                                if ($rowtraining->num_rows > 0) {
                                                    while ($training = $rowtraining->fetch_assoc()) {
                                                        $trainingID =  $training['training_id'];
                                                        $sql5 = "SELECT COUNT(*) AS total_rowsorder FROM orders WHERE training_id = '$trainingID' AND order_status = 1 ";
                                                        $resultlimit = mysqli_query($conn, $sql5);

                                                        if ($resultlimit->num_rows > 0) {
                                                            $rowuser = $resultlimit->fetch_assoc();
                                                            $totalRowsuser = $rowuser['total_rowsorder'];
                                                            // คำนวณและแสดงจำนวนแถวที่เหลือ
                                                            $remainingRows = max(0, $training["training_limit"] - $totalRowsuser);
                                                        }

                                                        $sql6 = "SELECT COUNT(*) AS total_rowsresult FROM orders WHERE training_id = '$trainingID' AND order_result = 'ผ่าน' ";
                                                        $resultorder = mysqli_query($conn, $sql6);
                                                        $rowresult = $resultorder->fetch_assoc();
                                                        $totalRowsresult = $rowresult['total_rowsresult'];
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p><?php echo $training['training_name'] ?></p>
                                                            </td>
                                                            <td>
                                                                <p class=""><?php echo $totalRowsuser . "/" . $training["training_limit"] . " คน"; ?></p>
                                                            </td>
                                                            <td class="text-center">
                                                                <p><?php echo $totalRowsresult . " คน"; ?></p>
                                                            </td>
                                                            <td>
